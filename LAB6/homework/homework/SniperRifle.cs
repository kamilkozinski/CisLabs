...
namespace homework
{
    class SniperRifle : Weapon, IAlterAmmunition
    {
        ...
        public SniperRifle(double m_ammunition, double m_max, IAlterWeapon m_extra)
        {
        ...
        {
            return "Sniper rifle ammunition " + PercentOfAmmo() + " %.";
        }
